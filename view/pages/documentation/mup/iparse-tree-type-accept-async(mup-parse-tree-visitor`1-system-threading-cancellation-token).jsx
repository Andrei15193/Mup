        ...
        return (
            <div>
                <ol class={Bootstrap.breadcrumb}>
                    ...
                    <li class={Bootstrap.active}>AcceptAsync&lt;TResult&gt;(ParseTreeVisitor&lt;TResult&gt;, CancellationToken)</li>
                </ol>
                <h2>AcceptAsync&lt;TResult&gt;(ParseTreeVisitor&lt;TResult&gt;, CancellationToken) Method</h2>
                <p>Asynchronously accepts a visitor which can be used to generate output from the parse tree.</p>
                <pre><code><span class={Bootstrap.textPrimary}>public</span> <span class={Bootstrap.textPrimary}>abstract</span> Task&lt;TResult&gt; AcceptAsync&lt;TResult&gt;(ParseTreeVisitor&lt;TResult&gt; visitor, CancellationToken cancellationToken)</code></pre>
