    ...
    render () {
        return (
            <div>
                ...
                <p>Visits an image.</p>
                <pre><code><span class={Bootstrap.textPrimary}>protected</span> <span class={Bootstrap.textPrimary}>virtual</span> <span class={Bootstrap.textPrimary}>void</span> VisitImage(<span class={Bootstrap.textPrimary}>string</span> source, <span class={Bootstrap.textPrimary}>string</span> alternative)</code></pre>
                <h3>Parameters</h3>
                <ul>
