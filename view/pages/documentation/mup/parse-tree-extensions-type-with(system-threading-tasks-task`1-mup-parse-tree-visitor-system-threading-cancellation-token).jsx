    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span class={Bootstrap.textPrimary}>public</span> <span class={Bootstrap.textPrimary}>static</span> Task With(<span class={Bootstrap.textPrimary}>this</span> Task&lt;IParseTree&gt; parseTask, ParseTreeVisitor visitor, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
