    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span class={Bootstrap.textPrimary}>public</span> <span class={Bootstrap.textPrimary}>virtual</span> Task&lt;IParseTree&gt; ParseAsync(TextReader reader, <span class={Bootstrap.textPrimary}>int</span> bufferSize)</code></pre>
                <h3>Parameters</h3>
                <ul>
