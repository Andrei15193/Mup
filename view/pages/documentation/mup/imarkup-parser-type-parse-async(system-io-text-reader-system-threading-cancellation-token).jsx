        ...
        return (
            <div>
                <ol class={Bootstrap.breadcrumb}>
                    ...
                    <li class={Bootstrap.active}>ParseAsync(TextReader, CancellationToken)</li>
                </ol>
                <h2>ParseAsync(TextReader, CancellationToken) Method</h2>
                <p>Asynchronously parses text from the given reader.</p>
                <pre><code><span class={Bootstrap.textPrimary}>public</span> <span class={Bootstrap.textPrimary}>abstract</span> Task&lt;IParseTree&gt; ParseAsync(TextReader reader, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
