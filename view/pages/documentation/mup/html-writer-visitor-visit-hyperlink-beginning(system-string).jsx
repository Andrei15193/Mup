    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span class={Bootstrap.textPrimary}>protected</span> <span class={Bootstrap.textPrimary}>override</span> <span class={Bootstrap.textPrimary}>void</span> VisitHyperlinkBeginning(<span class={Bootstrap.textPrimary}>string</span> destination)</code></pre>
                <h3>Parameters</h3>
                <ul>
