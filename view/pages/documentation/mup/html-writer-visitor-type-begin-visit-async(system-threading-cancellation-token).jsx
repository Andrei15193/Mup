    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span class={Bootstrap.textPrimary}>protected</span> <span class={Bootstrap.textPrimary}>sealed</span> Task BeginVisitAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
