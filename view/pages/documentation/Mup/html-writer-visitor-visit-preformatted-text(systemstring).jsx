    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span class={Bootstrap.textPrimary}>protected</span> <span class={Bootstrap.textPrimary}>override</span> <span class={Bootstrap.textPrimary}>void</span> VisitPreformattedText(<span class={Bootstrap.textPrimary}>string</span> preformattedText)</code></pre>
                <h3>Parameters</h3>
                <ul>
