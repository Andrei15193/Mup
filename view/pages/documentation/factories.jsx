...
import MupHtmlWriterVisitorVisitHeading2Beginning from "./Mup/html-writer-visitor-visit-heading2-beginning().jsx";
import MupHtmlWriterVisitorVisitHeading2Ending from "./Mup/html-writer-visitor-visit-heading2-ending().jsx";
import MupHtmlWriterVisitorVisitHeading3Beginning from "./Mup/html-writer-visitor-visit-heading3-beginning().jsx";
import MupHtmlWriterVisitorVisitHeading3Ending from "./Mup/html-writer-visitor-visit-heading3-ending().jsx";
import MupHtmlWriterVisitorVisitHeading4Beginning from "./Mup/html-writer-visitor-visit-heading4-beginning().jsx";
import MupHtmlWriterVisitorVisitHeading4Ending from "./Mup/html-writer-visitor-visit-heading4-ending().jsx";
import MupHtmlWriterVisitorVisitHeading5Beginning from "./Mup/html-writer-visitor-visit-heading5-beginning().jsx";
import MupHtmlWriterVisitorVisitHeading5Ending from "./Mup/html-writer-visitor-visit-heading5-ending().jsx";
import MupHtmlWriterVisitorVisitHeading6Beginning from "./Mup/html-writer-visitor-visit-heading6-beginning().jsx";
...
import MupHtmlWriterVisitorVisitTableRowEnding from "./Mup/html-writer-visitor-visit-table-row-ending().jsx";
import MupHtmlWriterVisitorVisitTableHeaderCellBeginning from "./Mup/html-writer-visitor-visit-table-header-cell-beginning().jsx";
import MupHtmlWriterVisitorVisitTableHeaderCellEnding from "./Mup/html-writer-visitor-visit-table-header-cell-ending().jsx";
import MupHtmlWriterVisitorVisitTableCellBeginning from "./Mup/html-writer-visitor-visit-table-cell-beginning().jsx";
import MupHtmlWriterVisitorVisitTableCellEnding from "./Mup/html-writer-visitor-visit-table-cell-ending().jsx";
import MupHtmlWriterVisitorVisitUnorderedListBeginning from "./Mup/html-writer-visitor-visit-unordered-list-beginning().jsx";
import MupHtmlWriterVisitorVisitUnorderedListEnding from "./Mup/html-writer-visitor-visit-unordered-list-ending().jsx";
import MupHtmlWriterVisitorVisitOrderedListBeginning from "./Mup/html-writer-visitor-visit-ordered-list-beginning().jsx";
...
const Factories = {
    ...
    "mup.creoleparser.parseasync(system.string,system.threading.cancellationtoken)": () => <MupCreoleParserParseAsyncSystemStringSystemThreadingCancellationToken />,
    "mup.creoleparser.parseasync(system.io.textreader)": () => <MupCreoleParserParseAsyncSystemIOTextReader />,
    "mup.creoleparser.parseasync(system.io.textreader,system.threading.cancellationtoken)": () => <MupCreoleParserParseAsyncSystemIOTextReaderSystemThreadingCancellationToken />,
    ...
    "mup.htmlwritervisitor.beginvisit()": () => <MupHtmlWriterVisitorBeginVisit />,
    "mup.htmlwritervisitor.endvisitasync(system.threading.cancellationtoken)": () => <MupHtmlWriterVisitorEndVisitAsyncSystemThreadingCancellationToken />,
    "mup.htmlwritervisitor.endvisit()": () => <MupHtmlWriterVisitorEndVisit />,
    "mup.htmlwritervisitor.visitheading1beginning()": () => <MupHtmlWriterVisitorVisitHeading1Beginning />,
    "mup.htmlwritervisitor.visitheading1ending()": () => <MupHtmlWriterVisitorVisitHeading1Ending />,
    "mup.htmlwritervisitor.visitheading2beginning()": () => <MupHtmlWriterVisitorVisitHeading2Beginning />,
    "mup.htmlwritervisitor.visitheading2ending()": () => <MupHtmlWriterVisitorVisitHeading2Ending />,
    "mup.htmlwritervisitor.visitheading3beginning()": () => <MupHtmlWriterVisitorVisitHeading3Beginning />,
    "mup.htmlwritervisitor.visitheading3ending()": () => <MupHtmlWriterVisitorVisitHeading3Ending />,
    "mup.htmlwritervisitor.visitheading4beginning()": () => <MupHtmlWriterVisitorVisitHeading4Beginning />,
    "mup.htmlwritervisitor.visitheading4ending()": () => <MupHtmlWriterVisitorVisitHeading4Ending />,
    "mup.htmlwritervisitor.visitheading5beginning()": () => <MupHtmlWriterVisitorVisitHeading5Beginning />,
    "mup.htmlwritervisitor.visitheading5ending()": () => <MupHtmlWriterVisitorVisitHeading5Ending />,
    "mup.htmlwritervisitor.visitheading6beginning()": () => <MupHtmlWriterVisitorVisitHeading6Beginning />,
    "mup.htmlwritervisitor.visitheading6ending()": () => <MupHtmlWriterVisitorVisitHeading6Ending />,
    "mup.htmlwritervisitor.visitparagraphbeginning()": () => <MupHtmlWriterVisitorVisitParagraphBeginning />,
    "mup.htmlwritervisitor.visitparagraphending()": () => <MupHtmlWriterVisitorVisitParagraphEnding />,
    "mup.htmlwritervisitor.visitpreformattedblock(system.string)": () => <MupHtmlWriterVisitorVisitPreformattedBlockSystemString />,
    "mup.htmlwritervisitor.visittablebeginning()": () => <MupHtmlWriterVisitorVisitTableBeginning />,
    "mup.htmlwritervisitor.visittableending()": () => <MupHtmlWriterVisitorVisitTableEnding />,
    "mup.htmlwritervisitor.visittablerowbeginning()": () => <MupHtmlWriterVisitorVisitTableRowBeginning />,
    "mup.htmlwritervisitor.visittablerowending()": () => <MupHtmlWriterVisitorVisitTableRowEnding />,
    "mup.htmlwritervisitor.visittableheadercellbeginning()": () => <MupHtmlWriterVisitorVisitTableHeaderCellBeginning />,
    "mup.htmlwritervisitor.visittableheadercellending()": () => <MupHtmlWriterVisitorVisitTableHeaderCellEnding />,
    "mup.htmlwritervisitor.visittablecellbeginning()": () => <MupHtmlWriterVisitorVisitTableCellBeginning />,
    "mup.htmlwritervisitor.visittablecellending()": () => <MupHtmlWriterVisitorVisitTableCellEnding />,
    "mup.htmlwritervisitor.visitunorderedlistbeginning()": () => <MupHtmlWriterVisitorVisitUnorderedListBeginning />,
    "mup.htmlwritervisitor.visitunorderedlistending()": () => <MupHtmlWriterVisitorVisitUnorderedListEnding />,
    "mup.htmlwritervisitor.visitorderedlistbeginning()": () => <MupHtmlWriterVisitorVisitOrderedListBeginning />,
    "mup.htmlwritervisitor.visitorderedlistending()": () => <MupHtmlWriterVisitorVisitOrderedListEnding />,
    "mup.htmlwritervisitor.visitlistitembeginning()": () => <MupHtmlWriterVisitorVisitListItemBeginning />,
    "mup.htmlwritervisitor.visitlistitemending()": () => <MupHtmlWriterVisitorVisitListItemEnding />,
    "mup.htmlwritervisitor.visitplugin(system.string)": () => <MupHtmlWriterVisitorVisitPluginSystemString />,
    "mup.htmlwritervisitor.visitstrongbeginning()": () => <MupHtmlWriterVisitorVisitStrongBeginning />,
    "mup.htmlwritervisitor.visitstrongending()": () => <MupHtmlWriterVisitorVisitStrongEnding />,
    "mup.htmlwritervisitor.visitemphasisbeginning()": () => <MupHtmlWriterVisitorVisitEmphasisBeginning />,
    "mup.htmlwritervisitor.visitemphasisending()": () => <MupHtmlWriterVisitorVisitEmphasisEnding />,
    "mup.htmlwritervisitor.visithyperlinkbeginning(system.string)": () => <MupHtmlWriterVisitorVisitHyperlinkBeginningSystemString />,
    ...
    "mup.htmlwritervisitor.appendhtmlsafe(system.char)": () => <MupHtmlWriterVisitorAppendHtmlSafeSystemChar />,
    "mup.imarkupparser": () => <MupIMarkupParser />,
    "mup.imarkupparser.parse(system.string)": () => <MupIMarkupParserParseSystemString />,
    "mup.imarkupparser.parseasync(system.string)": () => <MupIMarkupParserParseAsyncSystemString />,
    "mup.imarkupparser.parseasync(system.string,system.threading.cancellationtoken)": () => <MupIMarkupParserParseAsyncSystemStringSystemThreadingCancellationToken />,
    "mup.imarkupparser.parseasync(system.io.textreader)": () => <MupIMarkupParserParseAsyncSystemIOTextReader />,
    "mup.imarkupparser.parseasync(system.io.textreader,system.threading.cancellationtoken)": () => <MupIMarkupParserParseAsyncSystemIOTextReaderSystemThreadingCancellationToken />,
    "mup.imarkupparser.parseasync(system.io.textreader,system.int32)": () => <MupIMarkupParserParseAsyncSystemIOTextReaderSystemInt32 />,
    ...
    "mup.parsetreevisitor.endvisitasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorEndVisitAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.endvisit()": () => <MupParseTreeVisitorEndVisit />,
    "mup.parsetreevisitor.visitheading1beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading1BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading1beginning()": () => <MupParseTreeVisitorVisitHeading1Beginning />,
    "mup.parsetreevisitor.visitheading1endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading1EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading1ending()": () => <MupParseTreeVisitorVisitHeading1Ending />,
    "mup.parsetreevisitor.visitheading2beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading2BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading2beginning()": () => <MupParseTreeVisitorVisitHeading2Beginning />,
    "mup.parsetreevisitor.visitheading2endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading2EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading2ending()": () => <MupParseTreeVisitorVisitHeading2Ending />,
    "mup.parsetreevisitor.visitheading3beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading3BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading3beginning()": () => <MupParseTreeVisitorVisitHeading3Beginning />,
    "mup.parsetreevisitor.visitheading3endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading3EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading3ending()": () => <MupParseTreeVisitorVisitHeading3Ending />,
    "mup.parsetreevisitor.visitheading4beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading4BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading4beginning()": () => <MupParseTreeVisitorVisitHeading4Beginning />,
    "mup.parsetreevisitor.visitheading4endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading4EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading4ending()": () => <MupParseTreeVisitorVisitHeading4Ending />,
    "mup.parsetreevisitor.visitheading5beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading5BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading5beginning()": () => <MupParseTreeVisitorVisitHeading5Beginning />,
    "mup.parsetreevisitor.visitheading5endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading5EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading5ending()": () => <MupParseTreeVisitorVisitHeading5Ending />,
    "mup.parsetreevisitor.visitheading6beginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading6BeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading6beginning()": () => <MupParseTreeVisitorVisitHeading6Beginning />,
    "mup.parsetreevisitor.visitheading6endingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHeading6EndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitheading6ending()": () => <MupParseTreeVisitorVisitHeading6Ending />,
    "mup.parsetreevisitor.visitparagraphbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitParagraphBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitparagraphbeginning()": () => <MupParseTreeVisitorVisitParagraphBeginning />,
    "mup.parsetreevisitor.visitparagraphendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitParagraphEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitparagraphending()": () => <MupParseTreeVisitorVisitParagraphEnding />,
    "mup.parsetreevisitor.visitpreformattedblockasync(system.string,system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitPreformattedBlockAsyncSystemStringSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitpreformattedblock(system.string)": () => <MupParseTreeVisitorVisitPreformattedBlockSystemString />,
    "mup.parsetreevisitor.visithorizontalruleasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHorizontalRuleAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visithorizontalrule()": () => <MupParseTreeVisitorVisitHorizontalRule />,
    "mup.parsetreevisitor.visitpluginasync(system.string,system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitPluginAsyncSystemStringSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitplugin(system.string)": () => <MupParseTreeVisitorVisitPluginSystemString />,
    "mup.parsetreevisitor.visittablebeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittablebeginning()": () => <MupParseTreeVisitorVisitTableBeginning />,
    "mup.parsetreevisitor.visittableendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittableending()": () => <MupParseTreeVisitorVisitTableEnding />,
    "mup.parsetreevisitor.visittablerowbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableRowBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittablerowbeginning()": () => <MupParseTreeVisitorVisitTableRowBeginning />,
    "mup.parsetreevisitor.visittablerowendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableRowEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittablerowending()": () => <MupParseTreeVisitorVisitTableRowEnding />,
    "mup.parsetreevisitor.visittableheadercellbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableHeaderCellBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittableheadercellbeginning()": () => <MupParseTreeVisitorVisitTableHeaderCellBeginning />,
    "mup.parsetreevisitor.visittableheadercellendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableHeaderCellEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittableheadercellending()": () => <MupParseTreeVisitorVisitTableHeaderCellEnding />,
    "mup.parsetreevisitor.visittablecellbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableCellBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittablecellbeginning()": () => <MupParseTreeVisitorVisitTableCellBeginning />,
    "mup.parsetreevisitor.visittablecellendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitTableCellEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visittablecellending()": () => <MupParseTreeVisitorVisitTableCellEnding />,
    "mup.parsetreevisitor.visitunorderedlistbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitUnorderedListBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitunorderedlistbeginning()": () => <MupParseTreeVisitorVisitUnorderedListBeginning />,
    "mup.parsetreevisitor.visitunorderedlistendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitUnorderedListEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitunorderedlistending()": () => <MupParseTreeVisitorVisitUnorderedListEnding />,
    "mup.parsetreevisitor.visitorderedlistbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitOrderedListBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitorderedlistbeginning()": () => <MupParseTreeVisitorVisitOrderedListBeginning />,
    "mup.parsetreevisitor.visitorderedlistendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitOrderedListEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitorderedlistending()": () => <MupParseTreeVisitorVisitOrderedListEnding />,
    "mup.parsetreevisitor.visitlistitembeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitListItemBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitlistitembeginning()": () => <MupParseTreeVisitorVisitListItemBeginning />,
    "mup.parsetreevisitor.visitlistitemendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitListItemEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitlistitemending()": () => <MupParseTreeVisitorVisitListItemEnding />,
    "mup.parsetreevisitor.visitstrongbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitStrongBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitstrongbeginning()": () => <MupParseTreeVisitorVisitStrongBeginning />,
    "mup.parsetreevisitor.visitstrongendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitStrongEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitstrongending()": () => <MupParseTreeVisitorVisitStrongEnding />,
    "mup.parsetreevisitor.visitemphasisbeginningasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitEmphasisBeginningAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitemphasisbeginning()": () => <MupParseTreeVisitorVisitEmphasisBeginning />,
    "mup.parsetreevisitor.visitemphasisendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitEmphasisEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visitemphasisending()": () => <MupParseTreeVisitorVisitEmphasisEnding />,
    "mup.parsetreevisitor.visithyperlinkbeginningasync(system.string,system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHyperlinkBeginningAsyncSystemStringSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visithyperlinkbeginning(system.string)": () => <MupParseTreeVisitorVisitHyperlinkBeginningSystemString />,
    "mup.parsetreevisitor.visithyperlinkendingasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitHyperlinkEndingAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor.visithyperlinkending()": () => <MupParseTreeVisitorVisitHyperlinkEnding />,
    "mup.parsetreevisitor.visitimageasync(system.string,system.string,system.threading.cancellationtoken)": () => <MupParseTreeVisitorVisitImageAsyncSystemStringSystemStringSystemThreadingCancellationToken />,
    ...
    "mup.parsetreevisitor<tresult>.getresultasync(system.threading.cancellationtoken)": () => <MupParseTreeVisitor$1GetResultAsyncSystemThreadingCancellationToken />,
    "mup.parsetreevisitor<tresult>.getresult()": () => <MupParseTreeVisitor$1GetResult />
};
