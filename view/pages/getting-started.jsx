...
protected virtual void Visit{Element}()
{
                ...
                <p>Now that we have our demo project created, we will start by adding a <a href="https://www.nuget.org/">NuGet</a> dependency towards the <a href="https://www.nuget.org/packages/Mup/0.0.3-beta">Mup package</a>. Open <em>mup-example.csproj</em> (assuming you have the same folder name as I do, otherwise the <em>.csproj</em> file will have the same name as the folder in which you created your .NET Core application) and add the following line: <code>&lt;PackageReference Include=&quot;Mup&quot; Version=&quot;0.0.3-beta&quot; /&gt;</code>. The <em>.csproj</em> file should look something like this:</p>
...
{`<Project Sdk="Microsoft.NET.Sdk.Web">
  ...
  <ItemGroup>
    ...
    <PackageReference Include="Mup" Version="0.0.3-beta" />
  </ItemGroup>
