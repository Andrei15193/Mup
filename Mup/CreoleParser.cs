        ...
        : IMarkupParser
    {
        ...
        private class CreoleMarkupParser
        {
            ...
            internal CreoleMarkupParser(CreoleScanResult scanResult, IEnumerable<string> inlineHyperlinkProtocols)
            {
                ...
                {
                    new CreoleHeadingElementFactory(_text),
                    new CreolePluginElementFactory(_text),
                    new CreolePreformattedBlockElementFactory(_text),
                    new CreoleHorizontalRuleElementFactory(_text),
                    new CreoleTableElementFactory(_text, inlineHyperlinkProtocols),
                    new CreoleListElementFactory(_text, inlineHyperlinkProtocols),
                    new CreoleParagraphElementFactory(_text, inlineHyperlinkProtocols),
                    new CreoleBlankElementFactory(_text)
                };
            }
