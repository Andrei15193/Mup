...
namespace Mup
{
    ...
    {
        private static IReadOnlyCollection<string> _defaultInlineHyperlinkProtocols = new[] { "http", "https" };
        ...
        /// <summary>The protocols to consider when parsing inline hyperlinks (e.g.: http, https, ftp and so on). The defauts are <c>http</c> and <c>https</c>.</summary>
