            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">BeginVisitAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>BeginVisitAsync(CancellationToken) Method</h2>
                <p>Asynchronously initializes the visitor. This method is called before any visit method.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task BeginVisitAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
