    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span className={Style.textPrimary}>public</span> <span className={Style.textPrimary}>virtual</span> Task&lt;IParseTree&gt; ParseAsync(TextReader reader, <span className={Style.textPrimary}>int</span> bufferSize, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
