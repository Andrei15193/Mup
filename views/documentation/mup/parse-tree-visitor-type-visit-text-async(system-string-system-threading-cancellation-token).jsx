            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitTextAsync(string, CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitTextAsync(string, CancellationToken) Method</h2>
                <p>Asynchronously visits plain text. This method may be called multiple times consecutively.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitTextAsync(<span className={Style.textPrimary}>string</span> text, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
