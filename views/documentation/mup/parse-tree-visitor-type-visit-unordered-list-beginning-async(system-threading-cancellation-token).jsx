            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitUnorderedListBeginningAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitUnorderedListBeginningAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the beginning of an unordered list.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitUnorderedListBeginningAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
