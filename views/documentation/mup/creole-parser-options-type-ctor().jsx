    ...
    render () {
        return (
            <div>
                ...
                <p>Initializes a new instance of the <Link to={Routes.documentation({ member: "Mup.CreoleParserOptions" })}>CreoleParserOptions</Link> class.</p>
                <pre><code><span className={Style.textPrimary}>public</span> CreoleParserOptions()</code></pre>
            </div>
        );
    }
};
