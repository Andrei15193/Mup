            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitHyperlinkBeginningAsync(string, CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitHyperlinkBeginningAsync(string, CancellationToken) Method</h2>
                <p>Asynchronously visits the beginning of a hyperlink.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitHyperlinkBeginningAsync(<span className={Style.textPrimary}>string</span> destination, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
