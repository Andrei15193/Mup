    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> <span className={Style.textPrimary}>void</span> VisitText(<span className={Style.textPrimary}>string</span> text)</code></pre>
                <h3>Parameters</h3>
                <ul>
