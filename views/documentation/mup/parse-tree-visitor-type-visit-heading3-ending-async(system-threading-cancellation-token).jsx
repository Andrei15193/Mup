            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitHeading3EndingAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitHeading3EndingAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the ending of a level 3 heading.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitHeading3EndingAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
