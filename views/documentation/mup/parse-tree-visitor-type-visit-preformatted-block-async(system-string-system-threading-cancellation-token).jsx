            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitPreformattedBlockAsync(string, CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitPreformattedBlockAsync(string, CancellationToken) Method</h2>
                <p>Asynchronously visits a preformatted block.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitPreformattedBlockAsync(<span className={Style.textPrimary}>string</span> preformattedText, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
