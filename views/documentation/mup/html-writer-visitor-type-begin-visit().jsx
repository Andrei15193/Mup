    ...
    render () {
        return (
            <div>
                ...
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>sealed</span> <span className={Style.textPrimary}>void</span> BeginVisit()</code></pre>
            </div>
        );
    }
};
