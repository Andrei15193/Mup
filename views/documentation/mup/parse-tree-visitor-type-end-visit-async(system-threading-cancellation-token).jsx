            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">EndVisitAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>EndVisitAsync(CancellationToken) Method</h2>
                <p>Asynchronously completes the visit operation. This method is called after all visit methods.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task EndVisitAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
