            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitHeading5EndingAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitHeading5EndingAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the ending of a level 5 heading.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitHeading5EndingAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
