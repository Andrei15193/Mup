    ...
    render () {
        return (
            <div>
                ...
                <p>Visits an image.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> <span className={Style.textPrimary}>void</span> VisitImage(<span className={Style.textPrimary}>string</span> source, <span className={Style.textPrimary}>string</span> alternativeText)</code></pre>
                <h3>Parameters</h3>
                <ul>
