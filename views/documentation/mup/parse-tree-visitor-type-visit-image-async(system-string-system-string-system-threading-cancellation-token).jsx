            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitImageAsync(string, string, CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitImageAsync(string, string, CancellationToken) Method</h2>
                <p>Asynchronously visits an image.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitImageAsync(<span className={Style.textPrimary}>string</span> source, <span className={Style.textPrimary}>string</span> alternativeText, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
