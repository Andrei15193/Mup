            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">ParseAsync(string)</li>
                    </ol>
                </nav>
                <h2>ParseAsync(string) Method</h2>
                <p>Asynchronously parses the given text.</p>
                <pre><code><span className={Style.textPrimary}>public</span> <span className={Style.textPrimary}>virtual</span> Task&lt;IParseTree&gt; ParseAsync(<span className={Style.textPrimary}>string</span> text)</code></pre>
                <h3>Parameters</h3>
                <ul>
