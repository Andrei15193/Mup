            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">AcceptAsync(ParseTreeVisitor)</li>
                    </ol>
                </nav>
                ...
                <pre><code>Task AcceptAsync(ParseTreeVisitor visitor)</code></pre>
                <h3>Parameters</h3>
                <ul>
