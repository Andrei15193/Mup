            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitLineBreakAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitLineBreakAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits a line break.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitLineBreakAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
