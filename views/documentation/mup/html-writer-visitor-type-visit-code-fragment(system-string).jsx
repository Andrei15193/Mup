            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitCodeFragment(string)</li>
                    </ol>
                </nav>
                <h2>VisitCodeFragment(string) Method</h2>
                <p>Visits a code fragment inside a block (e.g.: paragraph, list item or table).</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>override</span> <span className={Style.textPrimary}>void</span> VisitCodeFragment(<span className={Style.textPrimary}>string</span> fragment)</code></pre>
                <h3>Parameters</h3>
                <ul>
