            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">With(Task&lt;IParseTree&gt;, ParseTreeVisitor, CancellationToken)</li>
                    </ol>
                </nav>
                ...
                <pre><code><span className={Style.textPrimary}>public</span> <span className={Style.textPrimary}>static</span> Task With(<span className={Style.textPrimary}>this</span> Task&lt;IParseTree&gt; parseTask, ParseTreeVisitor visitor, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
