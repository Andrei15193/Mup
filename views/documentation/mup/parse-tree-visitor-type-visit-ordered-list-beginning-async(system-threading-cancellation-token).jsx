            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitOrderedListBeginningAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitOrderedListBeginningAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the beginning of an ordered list.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitOrderedListBeginningAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
