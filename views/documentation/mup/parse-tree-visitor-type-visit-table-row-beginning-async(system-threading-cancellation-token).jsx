            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitTableRowBeginningAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitTableRowBeginningAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the beginning of a table row.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitTableRowBeginningAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
