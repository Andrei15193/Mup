            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">ParseAsync(TextReader, CancellationToken)</li>
                    </ol>
                </nav>
                <h2>ParseAsync(TextReader, CancellationToken) Method</h2>
                <p>Asynchronously parses text from the given reader.</p>
                <pre><code><span className={Style.textPrimary}>public</span> <span className={Style.textPrimary}>virtual</span> Task&lt;IParseTree&gt; ParseAsync(TextReader reader, CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
