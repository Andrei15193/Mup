            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitHeading6BeginningAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitHeading6BeginningAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the beginning of a level 6 heading.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitHeading6BeginningAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
