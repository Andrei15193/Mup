            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitEmphasisEndingAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitEmphasisEndingAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the ending of an emphasised element.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitEmphasisEndingAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
