            ...
            <div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol className={Style.breadcrumb}>
                        ...
                        <li className={[Style.breadcrumbItem, Style.active].join(" ")} aria-current="page">VisitTableHeaderCellEndingAsync(CancellationToken)</li>
                    </ol>
                </nav>
                <h2>VisitTableHeaderCellEndingAsync(CancellationToken) Method</h2>
                <p>Asynchronously visits the ending of a table header cell.</p>
                <pre><code><span className={Style.textPrimary}>protected</span> <span className={Style.textPrimary}>virtual</span> Task VisitTableHeaderCellEndingAsync(CancellationToken cancellationToken)</code></pre>
                <h3>Parameters</h3>
                <ul>
