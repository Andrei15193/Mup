...
namespace Mup.Tests
{
    public class CreoleParser_ParseAsync
    {
        ...
        [InlineData("* unordered list\ncannot be on 2 lines", new object[] { UnorderedListStart, ListItemStart, PlainText, ListItemEnd, UnorderedListEnd, ParagraphStart, PlainText, ParagraphEnd })]
        ...
        [InlineData("# ordered list\ncannot be on 2 lines", new object[] { OrderedListStart, ListItemStart, PlainText, ListItemEnd, OrderedListEnd, ParagraphStart, PlainText, ParagraphEnd })]
        ...
        [InlineData("* unordered list\ncannot go across lines", "<ul><li>unordered list</li></ul><p>cannot go across lines</p>")]
        [InlineData("* unordered list\n\nparagraph", "<ul><li>unordered list</li></ul><p>paragraph</p>")]
        [InlineData("# ordered list\ncannot go across lines", "<ol><li>ordered list</li></ol><p>cannot go across lines</p>")]
